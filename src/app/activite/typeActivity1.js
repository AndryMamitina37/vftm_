  ...
  return (
    ...
    >
      ...
      <Typography variant="h3" className="leading-[45px] mb-4 !text-green-900 ">
        Renforcement des capacit&eacute;s des organisations paysannes membres de
        VFTM
      </Typography>
            ...
            <Card shadow={false} className="p-0">
              ...
              >
                ...
                <Typography className="text-normal mb-4 !text-base text-blue-gray-500 ">
                  Formations à la gestion financi&egrave;re et suivi de la tenue
                  comptable des organisations paysannes, accompagnement pour
                  l’&eacute;laboration de rapports .
                </Typography>
              </CardBody>
            </Card>
          </div>
          ...
          <div className="!border-b  border-blue-gray-100 mb-5">
            <Card shadow={false} className="p-0">
              ...
              >
                ...
                <Typography className="text-normal mb-4 !text-base text-blue-gray-500 ">
                  Appui à la gestion associative (&eacute;change entre
                  &eacute;lus) .
                </Typography>
              </CardBody>
            </Card>
          ...
          <div className="!border-b  border-blue-gray-100 mb-5">
            <Card shadow={false} className="p-0">
              ...
              >
                ...
                <Typography className="text-normal mb-4 !text-base text-blue-gray-500 ">
                  Formation des &eacute;lus et des techniciens à la gestion des
          ...
          <div className="!border-b  border-blue-gray-100 mb-5">
            <Card shadow={false} className="p-0">
              ...
              >
                ...
                <Typography className="text-normal mb-4 !text-base text-blue-gray-500 ">
                  Aide aux organisations paysannes pour la mise en r&eacute;seau
                  et la recherche de partenaires techniques et financiers .
                </Typography>
              </CardBody>
            </Card>
          </div>
